...
<div class="three-col" style="text-align:center">
	<div class="col col1">
		...
		<p class="rez-thumb-cap"><em>Executive Design</em></p>
	</div>
	<div class="col col2">
		...
		<p class="rez-thumb-cap"><em>Modern Design</em></p>
	</div>
	<div class="col col3">
		<a href="/images/resume-examples/simple-template.jpg"><img class="resume-thumb" src="/images/resume-examples/simple-template.jpg"></a>
		<p class="rez-thumb-cap"><em>Simple Design</em></p>
	</div>
</div>
<div class="secondary">
	<!--<div class="col col1">
