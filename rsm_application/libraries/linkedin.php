...
class linkedin
{
    ...
    {
        $args = array('scope' => 'rw_nus', 'r_emailaddress', 'r_fullprofile', 'r_contactinfo');
    ...
    {
        $url = 'https://api.linkedin.com/v1/people/~:(id,first-name,last-name,email-address,phone-numbers,main-address,headline,honors,interests,specialties,certifications,educations,courses,member-url-resources,summary,picture-url,positions,primary-twitter-account,public-profile-url)';
        ...
        //$response = $this->httpRequest($url, $auth_header, "POST");
    ...
    function share($comment, $title, $url, $image_url, $access_token)
    {
        ...
        $response = $this->httpRequest($shareUrl, $auth_header, "POST");
