...
class Linked extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->data['callback_url'] = site_url() . 'user/linked/linkedin_submit';
    }

    function index()
    {
        echo anchor('user/linked/login', 'Sign in with Linkedin');
    }
    ...
    function linkedin_submit()
    {
        ...
        //echo anchor('linkedin/post', 'Post to Linkedin');
        
        $user = $this->linkedin->get_user_info(unserialize($auth_data['linked_in']));
